...
namespace Lab9
{
    static public class ExtensionMethods
    {
        ...
        // Sprawdzanie ilości znaków bez względu na wielkosc znaku (przeładowanie poprzedniej metody)
        public static int IleZnakow(this string ciag, char znak, int wielkosc)
        {
            if (wielkosc == 1)
            {
